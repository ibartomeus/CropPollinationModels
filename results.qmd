...
Similarly, we observe a large variation on the effect of pollinator richness, wild and honeybee visitation rates on crop yields, with an overall small, but positive effect sizes. 
...
plot(1:nrow(modelout_mod_R18), modelout_mod_R18$mean_rich, pch=19, col="#00a2ca", ylim=c(-.75,.75), ylab="richness slope (mean and 95% CI)", cex=1.5, xaxt = "n", xlab="crop study", main="Richness")
axis(1, at=seq(0,nrow(modelout_mod_R18),10), labels=seq(0,nrow(modelout_mod_R18),10))
